...
# Table of Contents
  ...
  8. [Basic Shell Programming](#8-basic-shell-programming)  
    8.1. [Variables](#21-variables)  
    8.2. [Array](#22-array)  
    8.3. [String Substitution](#23-string-substitution)  
    8.4. [Other String Tricks](#24-other-string-tricks)  
    8.5. [Functions](#25-functions)  
    8.6. [Conditionals](#26-conditionals)  
    8.7. [Loops](#27-loops)  
    8.8. [Regex](#28-regex)  
    8.9. [Pipes](#29-pipes)  
  9. [Tricks](#3-tricks)  
  10. [Debugging](#4-debugging)  
  11. [Multi-threading](#5-multi-threading)
...
### 2.19. ``chgrp`
It is used in Linux to change the group ownership of a file or directory.

Example:
```bash
chgrp developers myfile.txt # This command changes the group ownership of myfile.txt to the developers group.
```

### 2.20. `tar`
The `tar` (short for tape archive) command is used to create, extract, and manipulate archive files, usually with a .tar extension. It is widely used for packing files and directories into a single file for easy distribution or backup.
```bash
tar [options] [archive-file] [files or directories]
```
- `-c`: Create a new archive.
- `-x`: Extract the archive.
- `-f`: Specify the filename of the archive (this option should be used with -c, -x, or -t).
